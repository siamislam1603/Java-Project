...
import static typingmaster.frame3.jBSemi;
import static typingmaster.frame3.jBSpace;
import static typingmaster.frame3.jBa;
import static typingmaster.frame3.jBd;
import static typingmaster.frame3.jBf;
import static typingmaster.frame3.jBj;
import static typingmaster.frame3.jBk;
import static typingmaster.frame3.jBl;
import static typingmaster.frame3.jBs;
public class frame4 extends javax.swing.JFrame implements ActionListener,KeyListener {
    public frame4() {
        initComponents();
        addKeyListener(this);
        setFocusable(true);
    ...
    void file(){
        String g="";
        File f1=new File("paragraph.txt");
        try{
    ...
    private void initComponents() {
        ...
        jBslace = new javax.swing.JButton();
        ...
        jButton42.setText("\\");
            ...
            jBup.setBackground(new java.awt.Color(204, 204, 255));
            jBup.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
            jBup.setForeground(new java.awt.Color(0, 51, 255));
            jBup.setText("'");
            getContentPane().add(jBup);
            jBup.setBounds(795, 295, 61, 44);
            ...
            jBslace.setBackground(new java.awt.Color(204, 204, 255));
            jBslace.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
            jBslace.setForeground(new java.awt.Color(0, 51, 255));
            jBslace.setText("/");
            getContentPane().add(jBslace);
            jBslace.setBounds(740, 345, 62, 44);
            ...
            jL1.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
                public void propertyChange(java.beans.PropertyChangeEvent evt) {
                    jL1PropertyChange(evt);
                }
            });
            getContentPane().add(jL1);
            jL1.setBounds(10, 10, 960, 180);
    ...
    private void jL1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jL1PropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_jL1PropertyChange
    ...
    public void colorIndicator(){
        ...
        else if(c.charAt(prev) == 'r'||c.charAt(prev) == 't'||c.charAt(prev) == 'y'||c.charAt(prev) == 'u'||c.charAt(prev) == 'f'||c.charAt(prev) == 'g'||c.charAt(prev) == 'h'||c.charAt(prev) == 'j'||c.charAt(prev) == 'v'||c.charAt(prev) == 'b'||c.charAt(prev) == 'n'||c.charAt(prev) == 'm'){
            colorIndicate=3;
        }
    ...
    public void wordColorChange(){
        ...
        if(prev==c.length()){
            ...
            while(c.charAt(k)!=' '&& k<c.length()-1){
                k++;
                increment=true;
            }
            if(k==c.length()-1){
                if(increment==true){
                jL1.setText(String.format("<html>%s<u>%s</u>%s</html>", 
                ">",""+s1.charAt(prev),s1.substring(prev+1,s1.length())));
                }
                else{
                    System.out.println(k);
                    jL1.setText(String.format("<html>%s<u>%s</u></html>", 
                    ">",""+s1.charAt(prev)));
                    lastElement=true;
                }
            }
    ...
    public void keyPressed(KeyEvent e){
        ...
        else if(code==KeyEvent.VK_COMMA && c.charAt(prev)==','){
            wordCount++;
            prev=prev+1;
            wordColorChange();   
            a=prev-1;
...
*/
    ...
    double speed=0;
    boolean increment=false,lastElement=false;
    Timer timer;
    String c;
    ...
    private javax.swing.JButton jBslace;
